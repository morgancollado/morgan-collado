...
function HoverThumb({ active, reduced }) {
  ...
  if (reduced) {
    return <Box aria-hidden sx={thumbSx}>{inner}</Box>;
  }
  return (
    <Box
      aria-hidden
...
export default function TheIndex({ posts }) {
  ...
  return (
    ...
    >
      <Container maxWidth="lg" sx={{ pt: { xs: 6, md: 10 } }}>
        ...
        >
          Every essay, by the year it was made. Hover a title to glimpse its subject.
        </Typography>
        ...
        >
          {posts.map((post, i) => (
            <Box
              key={post.slug}
              component="li"
              sx={{ borderBottom: "1px solid", borderColor: "currentColor" }}
            ...
            >
              <Box
                ...
                sx={{
                  display: "grid",
                  gridTemplateColumns: { xs: "44px 1fr auto", md: "72px 1fr auto" },
                  gap: { xs: 2, md: 4 },
                  alignItems: "baseline",
                  py: { xs: 2.5, md: 3.5 },
                  textDecoration: "none",
              ...
              >
                ...
                <Box>
                  ...
                  >
                    {[post.category, yearOf(post.date)].filter(Boolean).join(" · ")}
                  </Typography>
                </Box>
                <Typography
                  sx={{

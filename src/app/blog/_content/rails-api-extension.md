...
1. Detect the unit of incoming data based on user preferences or explicit input.
2. Convert the incoming weight into a standard unit of measurement for consistent storage in our database.
3. Ensure that when data is retrieved or manipulated, it can be presented back in the user's preferred unit.

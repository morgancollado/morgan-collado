...
The third was that A/B testing is only as good as the question you are asking. Split made it cheap to run experiments, which meant we had to get disciplined about running ones that were worth running. A test that does not have a hypothesis is just noise with a control group.

What I liked most about this project was the part I did not own. The page kept evolving after I stopped working on it, and it evolved in directions I would not have predicted. That is the right outcome. A landing page is not a thing I should be a bottleneck for.
